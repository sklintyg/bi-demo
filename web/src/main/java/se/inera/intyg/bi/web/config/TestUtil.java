...
public class TestUtil {
     ...
     *            Expected string
     * @param actual
     *            Actual string returned by test case
     */
     ...
     *            Actual string returned by test case
     * @param java
     *            Whether to print the actual value as a Java string literal
     *            if the strings differ
     * @param message
     *            Message to print if the strings differ
     */
    public static void assertEqualsVerbose(
        ...
        message += "Expected:" + NL + expected + NL
                + "Actual:" + NL + actual + NL;
        if (java) {
